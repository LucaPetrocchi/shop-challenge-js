import { Product, appendCart, getProductsByCategory } from "../container.js"

const queryString = window.location.search,
  urlParams = new URLSearchParams(queryString),
  category = urlParams.get('category')

let productList: Product[] | undefined | null
...
const buildCategory = async (productList: Product[], mainDiv: HTMLElement) => {
